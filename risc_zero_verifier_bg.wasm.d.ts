...
export function get_risc0_version(a: number): void;
export function binary_to_json(a: number, b: number, c: number): void;
export function verify_receipt_json(a: number, b: number, c: number, d: number, e: number): void;
export function verify_receipt_binary(a: number, b: number, c: number, d: number, e: number): void;
...
export function sys_verify_integrity2(a: number, b: number): void;
