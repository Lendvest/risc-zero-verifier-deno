...
export const get_risc0_version: () => [number, number, number];
export const binary_to_json: (a: number, b: number) => [number, number, number];
export const verify_receipt_json: (a: number, b: number, c: number, d: number) => [number, number, number];
export const verify_receipt_binary: (a: number, b: number, c: number, d: number) => [number, number, number];
